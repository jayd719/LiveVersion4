"""
Django settings for LiveVersion4 project.
...
SECRET_KEY = 'django-insecure-fde1*k+g4j5&l0q+xoikz^$e5oatk5$r%xyxs!$d03v55@m$lz'
...
ROOT_URLCONF = 'LiveVersion4.urls'
...
WSGI_APPLICATION = 'LiveVersion4.wsgi.application'
